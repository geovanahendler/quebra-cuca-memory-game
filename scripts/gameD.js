// Importações
import { imagensDuplicadas, containerDoJogo, elementoPontuacao, elementoMovimentos, embaralharArray } from './configD.js';

// Importa a classe Carta
import { Carta } from './cardD.js';
...
export const IniciarTempo = () => {
  ...
  if (botaoIniciar.disabled || tempoRestante !== 90|| modalVisivel()) return;
